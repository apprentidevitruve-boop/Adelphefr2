...
const TENUE_DEGREE_LABEL = {
  apprentice: 'Tenue au 1er degré de la Franc-Maçonnerie',
  fellowcraft: 'Tenue au 2e degré de la Franc-Maçonnerie',
  master: 'Tenue au 3e degré de la Franc-Maçonnerie',
};
export const degreeTenueLabel = (k) => TENUE_DEGREE_LABEL[k] || '';
...
export const MEETING_TYPES = [
  ...
  { key: 'private', label: 'Tenue privée' },
];

// Par cohérence avec l'anonymisation des membres (3 lettres du prénom
// + 3 lettres du nom), on applique la même règle à l'affichage des
// contacts du bureau sur les pages consultées par les membres (fiche
// loge, Ma loge) — le nom complet reste visible côté administration.

...
export function convocationEmailHtml({ lodgeName, riteName, meetingDate, meetingTime, address, link, agapesLine, customMessage }) {
  return `
    <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #111;">
      ...
      ${customMessage ? `<p style="font-size: 14px; line-height: 1.6;">${escapeHtml(customMessage)}</p>` : ''}
